...
public class ExceptionTests
{
    ...
    public void Test_CalculateDiscount_NegativeDiscount_ThrowsArgumentException()
    {
        ...
        Assert.AreEqual(result.Message, "Discount must be between 0 and 100. (Parameter 'discount')"); // Judge íå ïðîâåðÿâà òîâà
    }
    ...
    public void Test_CalculateDiscount_DiscountOver100_ThrowsArgumentException()
    {
        ...
        // Act & Assert
        Assert.That(() => _exceptions.ArgumentCalculateDiscount(finalPrice, discount), Throws.ArgumentException); // Ïðàâè ñúùàòà ïðîâåðêà êàòî äîëíàòà
    ...
    public void Test_GetElement_IndexLessThanZero_ThrowsIndexOutOfRangeException()
    {
        ...
        // Act & Assert
        //Assert.That(() => this._exceptions.IndexOutOfRangeGetElement(input, index), Throws.TypeOf<IndexOutOfRangeException>());
    ...
    public void Test_GetElement_IndexGreaterThanArrayLength_ThrowsIndexOutOfRangeException()
    {
        ...
        // Act & Assert
        IndexOutOfRangeException result = Assert.Throws<IndexOutOfRangeException>(() => this._exceptions.IndexOutOfRangeGetElement(input, index));

        Assert.AreEqual(result.Message, "Index is out of range."); // Judge íå ïðîâåðÿâà òîâà
    }
    ...
    public void Test_PerformSecureOperation_UserNotLoggedIn_ThrowsInvalidOperationException()
    {
        ...
        Assert.Throws<InvalidOperationException>(() => _exceptions.InvalidOperationPerformSecureOperation(false));
    }
